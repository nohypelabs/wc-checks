...
export const ReportsPage = () => {
 ...
 return (
 <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900" data-tour="reports-page">
 {/* Header */}
   ...
   <div className="px-4">
     <div className="flex items-center justify-between">
       <div>
         ...
         <p className="text-sm text-white/50">Riwayat & analitik inspeksi</p>
       </div>
       {headerRightContent}
     </div>
   </div>
