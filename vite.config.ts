// vite.config.ts - NO PWA (removed for stability)
...
export default defineConfig(({ mode }) => ({
  plugins: [
    react(),
    // ❌ PWA REMOVED: Too many offline mode issues
    // App requires internet anyway (Cloudinary uploads, Supabase auth/database)
    // Just use as normal web app - simpler & more stable!
  ],
